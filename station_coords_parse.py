...
class Station_Coords:
    ...
    #first direction is north, second is main
    def add_neighbor(self, station: str, line: str, neighbor_n: str, neighbor_s: str):
...
sc.add_neighbor("Brighton Beach", "B", "temp station", "temp south station")
#'''