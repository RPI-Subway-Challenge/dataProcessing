...
class Station_Coords:
    ...
    #given a coordinate return an index
    def get_index_from_coord(self, coord: tuple) -> int:
        lat = coord[0]
        lon = coord[1]
        for i in range(len(self.station_data)):
            station = self.station_data[i]
            station_lat = station[1][1]
            station_lon = station[1][0]
...
###################################################################
#  self.station data structure
#  name, (lat, lon), lines, alt_id 
##################################################################